...
import { LayoutGrid, MapPin, Search, PhoneCall, Mail, Bell, ShoppingCart, HelpCircle } from 'lucide-react';
...
const Header: FC<HeaderProps> = ({ onTabChange, activeTab }) => {
  ...
  return (
    <div className="font-sans flex-none">
      {/* Top Header */}
      <div className="flex justify-between items-center p-2.5 text-sm border-b border-gray-300">
        ...
        <div className="hidden md:flex items-center gap-2.5">
          ...
          <span>
            <HelpCircle className="text-gray-500 mr-1" /> How it works
          </span>
          <span className="w-px h-4 bg-gray-500 mx-2.5"></span>
          <span>
            <FaHeadset className="text-gray-500 mr-1" /> Help Center
          </span>
        </div>
      </div>
